...
From here on you can do a lot more. Now that you have a validated JSON input, you can use it to create a user in a database, write the activation route, and so many more things. Check out the [earlier issues](https://shuttle.dev/launchpad) where we create a CRUD app with SQLX and PostgreSQL.
...
[_Best Rust Web Frameworks to Use in 2023_](https://shuttle.dev/blog/2023/08/23/rust-web-framework-comparison): A detailed analysis of Rust web frameworks by yours truly.

[_Semantic Search with Qdrant, OpenAI and Shuttle_](https://shuttle.dev/blog/2023/09/08/building-semantic-search-in-rust): A new blog article by yours truly on how to create a semantic search engine that actually works!

[_Logging in Rust - How to Get Started_](https://shuttle.dev/blog/2023/09/20/logging-in-rust): This article will help you gain insight on what the best log crate for your use case when it comes to Rust logging.
