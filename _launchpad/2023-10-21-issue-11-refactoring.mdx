...
`KVError` is a custom error type that we created just like in  [Shuttle Launchpad Issue #5](https://shuttle.dev/launchpad/issues/2023-28-07-issue-05-Traits-Image-Processing).
...
[_Rust vs Go: A comparison_](https://shuttle.dev/blog/2023/09/27/rust-vs-go-comparison): Matthias Endler creates the same app in Rust and Go. Let's see what he figures out.

[_Using GraphQL in Rust_](https://shuttle.dev/blog/2023/10/16/graphql-in-rust): A tutorial on how to use GraphQL in Rust.
