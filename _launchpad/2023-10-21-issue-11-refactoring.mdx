...
2. We work with a HashMap! What if we want to add a real database, like what we offer at [Shuttle](https://docs.shuttle.dev/resources/shuttle-shared-db)? How would we change our code?
