...
If you are completely new to Rust, check out [the archive](https://shuttle.dev/launchpad) as we have a ton of issues for beginners.
...
[_Logging in Rust_](https://shuttle.dev/blog/2023/09/20/logging-in-rust): What possibilities do you have to log when creating a web application other than `println!`? This article shows you the most popular frameworks.
