...
Welcome to the third issue of Shuttle Launchpad! Before we go into the nitty gritty details of today's issue, let's take some time to celebrate the Shuttle reaching beta status! 🎉 Check out all our announcements on [shuttle.rs/beta](https://www.shuttle.dev/beta).
...
[_Shuttle Beta_](https://www.shuttle.dev/beta): Shuttle reached Beta! Celebrate with us!
