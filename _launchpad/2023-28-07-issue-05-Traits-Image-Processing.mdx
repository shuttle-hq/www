...
# Shuttle Launchpad #5: Our first foray into traits, building an image-processing app!

Welcome to the next issue of Launchpad! This time we look at traits and create a little image-processing app. Enjoy!

## Our first foray into traits with an image-processing app
