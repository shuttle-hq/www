...
**Is this your first issue of _Launchpad_?**, check out the [Archive](https://shuttle.dev/launchpad/issues/2023-06-16-issue-01-Getting-Started) on shuttle.dev.
...
![Screenshot of the web application root](https://shuttle.dev/images/launchpad/1/screenshot.png)
![Screenshot of the web application podcast](https://shuttle.dev/images/launchpad/1/screenshot2.png)
...
[_Shuttle AI_](https://shuttle.dev/ai): We've just opened up the waitlist for Shuttle AI, a tool that allows you to build, validate & deploy an app, from a single prompt!
