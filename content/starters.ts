...
export const AllStartersContent: StarterAttrsContent[] = [
    ...
    },
    {
        ...
        icon: 'react',
        featured: true,
        description: 'Use WebSockets, React and Rust to release a chat app end-to-end.',
        sourceLink: 'https://github.com/joshua-mo-143/react-websocket-chat-rust',
        postLink: 'https://joshmo.hashnode.dev/building-deploying-a-chat-app-with-react-typescript-rust'
    },
    {
        title: 'Calendar',
        icon: 'calendar',
...
export const FeaturedStartersContent: StarterAttrs[] = AllStartersContent.filter(({featured}) => featured || false)
