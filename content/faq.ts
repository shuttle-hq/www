...
export const pricingQuestions: QuestionAttrs[] = [
  {
    question:
      "What makes Shuttle different from other solutions like Heroku, Supabase, or Vercel?",
    answer:
      'Shuttle revolutionizes backend development by saving you valuable time. With our <a href="https://docs.shuttle.dev/introduction/how-shuttle-works" target="_blank" style="text-decoration: underline;">infrastructure from code approach</a>, you can provision resources directly within your Rust codebase. Say goodbye to complex config files and the need to navigate through the AWS console. With a single line of code, your resources are ready. This efficiency translates to faster development cycles, allowing you to focus on building your application instead of managing or learning how to manage infrastructure.',
  },
  {
    question: "Is Shuttle open source?",
    answer:
      'Yes, Shuttle is <a href="https://github.com/shuttle-hq" target="_blank" style="text-decoration: underline;">open source</a> enabling developers to not only use but also contribute to our platform. We believe in the power of open collaboration and transparency.',
  },
  {
    question: "What about frontend hosting?",
    answer:
      "You can build any frontend app compiled to HTML/CSS/JS/WASM. Then, deploy and serve it with your Shuttle app.",
  },
  {
