...
export const Plans: PlanProps[] = [
  {
    ...
    name: "Community",
    description:
      "Everything you need to simply run your hobby projects. On us.",
    price: "$0",
    term: "/ month",
    ...
    textGradient:
      "linear-gradient(69deg, #FC540C -4.04%, rgba(255, 215, 111, 0.72) 218.65%, #38D4E9 304.95%)",
    cta: "Start deploying",
  },
  {
    key: "pro",
    name: "Pro",
    description:
      "For more professional use cases - raise limits and get access to more resources.",
    price: "$20",
    term: "/ user / month",
    billsResources: true,
    features: [
