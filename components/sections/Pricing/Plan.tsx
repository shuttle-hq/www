...
const Plan: FC<PlanProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="z-[5]">
        <h1 className="mb-2 font-gradual text-[32px] font-bold text-head">
          {name}
        </h1>
        ...
        {billsResources && (
          <p className="font-gradual text-body">+ RESOURCE USAGE</p>
        )}
        <hr
          className={clsx(
            "mb-5 border-[#7A7A7A]",
            billsResources ? " mt-6 " : " mt-12",
          )}
        />
      ...
      {name === "Pro" && (
        <button
          className={"absolute -bottom-12 left-0 z-[5] w-full text-white"}
        >
          <Link
