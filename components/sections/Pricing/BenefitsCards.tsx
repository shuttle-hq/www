...
const BenefitCards = () => (
  <div className="relative hidden sm:block">
    ...
    <div className="mx-auto mt-24 w-full max-w-7xl px-5 sm:px-10">
      <h1 className="mb-12 text-center font-gradual text-4xl font-bold text-head">
      ...
      <div className="grid gap-8 lg:grid-cols-3">
        ...
        >
          ...
          <p className="text-body">
            Effortless database connections, built-in logging, extensive docs,
        ...
        >
          ...
          <p className="text-body">
            Get your entire infrastructure configured without writing any
        ...
        >
          ...
          >
            <path
              d="M4 25V7L15.6063 16L4 25ZM17.3937 25V7L29 16L17.3937 25Z"
              fill="#D8D8D8"
            />
          </svg>
          <h1 className="font-gradual text-2xl font-bold text-head ">
          ...
          <p className="text-body">
            Leapfrog traditional DevOps with our &apos;Infrastructure from
            Code&apos; approach.
          </p>
        </div>
        <div
        ...
        >
          ...
          <p className="text-body">
            Be confident at compile time that you will get the resources you
            need. No surprises.
          </p>
        </div>
        <div
        ...
        >
          ...
          <Link
            href="https://github.com/shuttle-hq/shuttle/issues"
            target="_blank"
          >
            <p className="cursor-pointer text-body underline">
              Request a feature
            </p>
          </Link>
        </div>
