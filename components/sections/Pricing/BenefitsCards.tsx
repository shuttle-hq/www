...
const BenefitCards = () => (
	<div className='relative hidden sm:block'>
		...
		<div className='mx-auto mt-24 w-full max-w-7xl px-5 sm:px-10'>
			<h1 className='mb-12 text-center font-gradual text-4xl font-bold text-head'>Included in all plans</h1>
			<div className='grid gap-8 lg:grid-cols-3'>
				...
				>
					...
					<h1 className='font-gradual text-2xl font-bold text-head '>Rust, made simple</h1>
				...
				>
					...
					<h1 className='font-gradual text-2xl font-bold text-head '>Infrastructure from Code</h1>
					<p className='text-body'>
				...
				>
					...
					<h1 className='font-gradual text-2xl font-bold text-head '>Bypass DevOps</h1>
					<p className='text-body'>
				...
				>
					...
					<h1 className='font-gradual text-2xl font-bold text-head '>Compile-time assurance</h1>
					<p className='text-body'>
				...
				>
					...
					<h1 className='font-gradual text-2xl font-bold text-head '>Build fast, redeploy instantly</h1>
					<p className='text-body'>
				...
				>
					...
					<h1 className='font-gradual text-2xl font-bold text-head '>
						Got something you&apos;d like to see here?
					</h1>
					<Link href='https://github.com/shuttle-hq/shuttle/issues' target='_blank'>
						<p className='cursor-pointer text-body underline'>Request a feature</p>
					</Link>
				</div>
			</div>
		</div>
