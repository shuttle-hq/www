...
export const PricingCard: React.FC<PricingCardProps> = ({
  ...
  return (
    <article className="w-full sm:w-1/2 xl:w-1/4 px-4 pb-4 sm:px-2 xl:pb-0">
      <div className="overflow-hidden transition transition-500 p-8 bg-black border border-solid border-white/30 min-w-60 rounded-[32px]">
