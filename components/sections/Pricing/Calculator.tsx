			...
			<div className='mx-auto mt-14 flex w-full max-w-7xl flex-col gap-[200px] px-5 sm:flex-row sm:px-10 lg:mt-14'>
				<div className=' flex max-w-[400px] flex-col items-start justify-center'>
					...
					<p className='mb-10 text-[#7A7A7A] sm:text-xl'>
						Use our interactive pricing estimator to find out your compute resources requirements and
						get an accurate projection of additional usage-based cost
					</p>
				...
				<div className='z-[10] flex w-full flex-col'>
					...
					<div className='mb-12 grid grid-cols-2 gap-8'>
						<div className='flex flex-col items-center rounded-[24px] bg-[#00000033] p-5'>
							<h1 className='font-gradual text-[32px] font-bold text-white'>1 GB</h1>
							<p className='text-[20px]'>RAM</p>
						</div>
						<div className='flex flex-col items-center rounded-[24px] bg-[#00000033] p-5'>
							<h1 className='font-gradual text-[32px] font-bold text-white'>250 k</h1>
