  ...
  return (
    <>
      <div className="mx-auto mt-24 w-full max-w-[800px] px-5 sm:mt-28 sm:px-10 lg:mt-32 xl:mt-36 desktop:mt-52">
        <h2 className="font-gradual text-4.5 font-bold leading-none text-head">
          Get started in seconds
        </h2>
        <p className="mt-5 lg:text-xl">
          Build an app with your favourite Rust framework and deploy it
          immediately. We’ll take care of all the infrastructure.
        </p>
      </div>
  ...
  return (
    <div
      ...
      className={clsx(
        ...
        isSelected
          ? clsx("bg-gradient-to-r to-transparent", gradient)
          : "transparent",
      )}
    >
      <div
        className={clsx(
          "rounded-2xl bg-[#E9E9E9] p-6 after:rounded-2xl dark:bg-black",
        )}
      >
