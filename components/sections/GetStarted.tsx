...
const GetStartedSlide: FC<GetStartedSlideProps> = ({ number, title, text, children }) => {
	return (
		<SplideSlide className='max-w-[85%] p-[1px] lg:max-w-full lg:pb-4 lg:last:pb-1'>
			<div
				className={clsx(
					'border-gradient group relative h-full cursor-pointer cursor-pointer rounded-2xl rounded-2xl bg-white p-6 p-6 outline outline-1 outline-black/10 transition after:rounded-2xl hover:outline-none dark:bg-black hover:lg:outline-none',
