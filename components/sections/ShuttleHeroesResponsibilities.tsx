		...
		<div className='mx-auto mt-24 w-full max-w-7xl border-y border-black/10 px-5 pb-52 pt-32 dark:border-white/10 sm:px-10 lg:mt-28'>
			...
			<div className='mt-24 grid gap-5 lg:grid-cols-4'>
				<div className='flex items-start gap-4'>
					...
					/>
					<div>
						<h3 className='font-gradual text-xl font-bold dark:text-head'>Help</h3>
						<p className='mt-1'>
				...
				<div className='flex items-start gap-4'>
					...
					/>
					<div>
						<h3 className='font-gradual text-xl font-bold dark:text-head'>Spreading the word</h3>
						<p className='mt-1'>
				...
				<div className='flex items-start gap-4'>
					...
					/>
					<div>
						<h3 className='font-gradual text-xl font-bold dark:text-head'>Educate</h3>
						<p className='mt-1'>
				...
				<div className='flex items-start gap-4'>
					...
					/>
					<div>
						<h3 className='font-gradual text-xl font-bold dark:text-head'>Contribute</h3>
