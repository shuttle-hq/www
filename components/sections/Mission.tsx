				...
				<span className='pointer-events-none'>
					<div className='relative z-10 mx-auto max-w-3xl'>
						...
						<p className='mt-3 max-w-[800px] text-xl sm:mt-5 lg:text-xl'>
							We are replacing container technology, that almost every other cloud platform relies
							on, with something more lightweight and simple, resulting in the fastest deploy times
							ever. We are talking tens of minutes down to milliseconds. This is a game changer for
							developer productivity - cutting down those development cycles once and for all.
						</p>
						<p className='mt-3 max-w-[800px] text-xl sm:mt-5 lg:text-xl'>
