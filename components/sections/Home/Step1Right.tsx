export default function Step1Right({ className, id }: { className?: string; id: string }) {
	return (
		<div
			id={id}
			className={`z-40 rounded-[24px] border border-[#525150] bg-black p-4 ${className} left-0 right-0 top-[320px] mx-auto w-full sm:w-[500px] lg:left-[auto] lg:right-[3%] lg:top-[20%]`}
		>
