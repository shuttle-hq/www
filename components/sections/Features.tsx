		...
		<div className='mt-28 px-5 sm:mt-32 sm:px-10 lg:mt-36 xl:mt-40' id='features'>
			...
			<div className='mx-auto mt-16 grid w-full max-w-[1280px] gap-5 lg:grid-cols-2 xl:grid-cols-3 xl:grid-rows-6'>
				<div className='group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_4]'>
					...
					/>
					<Skip />
					<h3 className='font-gradual text-2xl font-bold text-head'>Rust, made simple</h3>
					<p>
				...
				<div className='group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_2]'>
					...
					<Image
						...
						className='pointer-events-none absolute left-0 top-0 -z-10 h-full w-full rounded-4xl object-contain transition-transform duration-1000 group-hover:-translate-x-10 group-hover:-translate-y-1'
					/>
					<h3 className='font-gradual text-2xl font-bold text-head'>Vercel for Backends</h3>
				...
				<div className='group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_3] xl:justify-end'>
					...
					/>
					<Open />
					<h3 className='font-gradual text-2xl font-bold text-head'>No Vendor lock-in</h3>
					<p>
				...
				<div className='group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_4]'>
					...
					/>
					<Deploy />
					<h3 className='font-gradual text-2xl font-bold text-head'>Build fast, redeploy instantly</h3>
					<p>
				...
				<div className='group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_3]'>
					...
					<Image
						...
						className='pointer-events-none absolute left-0 top-0 -z-10 h-full w-full rounded-4xl object-contain transition-transform duration-1000 group-hover:-translate-x-10 group-hover:-translate-y-1'
					/>
					<h3 className='font-gradual text-2xl font-bold text-head'>Forever-free tier</h3>
