...
const Features = () => {
  return (
    <div
      className="mt-28 px-5 sm:mt-32 sm:px-10 lg:mt-36 xl:mt-40"
      id="features"
    >
      <div className="mx-auto w-full max-w-[1100px] xl:grid xl:grid-cols-[700px_auto] xl:gap-5">
        <div className="max-w-[700px] xl:py-10">
          <h2 className="font-gradual text-5xl font-bold text-head lg:text-[3.5rem]">
            Bring your code, we&apos;ll handle the rest
          </h2>
          <p className="mt-5 text-xl text-body lg:text-2xl">
            Leave the deployment to us and focus on what matters, writing good
            code.
          </p>
        </div>
        <div className="group relative hidden bg-[#13292C] text-head dark:bg-black xl:block xl:overflow-hidden xl:rounded-4xl">
          <Image
      ...
      <div className="mx-auto mt-16 grid w-full max-w-[1280px] gap-5 lg:grid-cols-2 xl:grid-cols-3 xl:grid-rows-6">
        <div className="group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_4]">
          <Image
          ...
          <p>
            Shuttle makes it easy to connect to databases, has out-of-the-box
        ...
        <div className="group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_2]">
          ...
          <p>
            Get an entire infrastructure configured without writing any
            infrastructure config.
          </p>
          <Compile />
        </div>
        <div className="group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_3] xl:justify-end">
          <Image
          ...
          <p>
            No need to have your app hosted on our servers, you can deploy it to
            your own cloud or even run shuttle in your garage.
          </p>
        </div>
        <div className="group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[5/7]">
          <Image
        ...
        <div className="group relative z-10 flex flex-col items-start gap-3 overflow-hidden rounded-4xl bg-[#13292C] p-5 text-body dark:bg-black sm:p-8 xl:row-[span_4]">
          ...
          <p>
            Shuttle always uses the cache from previous builds to give you
