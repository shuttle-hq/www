			...
			<div className='mt-24 w-full'>
				<div className='mt-14 grid gap-5 lg:grid-cols-3'>
					<div className='flex items-start gap-4'>
						...
						/>
						<div>
							<h3 className='font-gradual text-xl font-bold dark:text-[#C2C2C2]'>Efficiency</h3>
					...
					<div className='flex items-start gap-4'>
						...
						/>
						<div>
							<h3 className='font-gradual text-xl font-bold dark:text-[#C2C2C2]'>Function</h3>
					...
					<div className='flex items-start gap-4'>
						...
						/>
						<div>
							<h3 className='font-gradual text-xl font-bold dark:text-[#C2C2C2]'>Community</h3>
