    ...
    <div className="group relative z-10 mt-24 overflow-hidden py-24 lg:mt-32">
      <span className="pointer-events-none">
        ...
        <Image
          ...
          alt=""
          fill
          className="absolute left-0 top-0 -z-10 hidden h-full w-full object-contain transition-transform duration-1000 group-hover:-translate-x-32 group-hover:translate-y-32 md:block"
        />
        <Image
          src="/images/sections/team/planet.png"
          alt=""
          fill
          className="absolute left-0 top-0 -z-10 hidden h-full w-full object-contain transition-transform duration-1000 group-hover:-translate-y-12 group-hover:translate-x-12 md:block"
        />
      </span>
      <div className="mx-auto w-full max-w-7xl px-5 sm:px-10">
        <div className="xl:px-20">
          <h2 className="font-gradual text-4.5 font-bold leading-none text-white dark:text-head lg:text-[3.5rem]">
            The team that’s making it happen
          </h2>
          <p className="mt-3 max-w-[800px] text-xl text-head dark:text-body sm:mt-5 lg:text-2xl">
            We share a vision for creating a new kind of developer experience, a
            passion for open source software and over 4 years of experience
  ...
  return (
    <div className="rounded-[1.25rem] border border-white border-opacity-10 p-6 backdrop-blur-2xl">
      ...
      <div className="mt-2 space-y-1">
        <h3 className="font-gradual text-2xl font-bold text-head">{name}</h3>
        <p className="text-sm text-body">{position}</p>
