            ...
            {TIERS.map((t) => (
              ...
              >
                {PRICING_ROWS.map((r) => (
                  <div
                    key={r.desc}
                    className="flex justify-between gap-6 py-[0.625rem]"
                  >
          ...
          <div className="hidden divide-y divide-black/10 text-xl dark:divide-white/10 lg:block">
            <div className="mb-8 grid grid-cols-[5fr_4fr_4fr_4fr] py-[0.875rem]">
              ...
              {TIERS.map((t) => (
                <div
                  key={t.name}
                  className="text-center text-black dark:text-body"
                >
                  <div className="mb-4 font-gradual text-2xl font-bold">
                    {t.displayName}
                  </div>
                  <div className="mx-auto mb-4 w-4/5 text-base text-body">
                    {t.desc}
                  </div>
                  <Button
