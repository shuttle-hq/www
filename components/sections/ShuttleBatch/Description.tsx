      ...
      <section className="mx-auto mt-24 w-full max-w-7xl items-center px-5 sm:px-10 lg:mt-28">
        <div className="relative my-10 flex flex-col gap-5 lg:py-40 lg:pl-[278px] lg:pr-52">
          ...
          <p className="text-2xl text-head">
            “I came into the first Batch with very little Rust expereience,
            having read most of the Rust book I was looking to get involved in
            Open Source to better my knowledge.
          </p>
          <p className="text-2xl text-head">
            The relaxed but supportive vibe in Batch was the perfect way for me
            to get to know the language better, to mix with people at a similar
            skill level, and to get quality guidence from the more experienced
            guys at Shuttle.”
          </p>
      ...
      <section className="relative pb-28">
        ...
        <div className="relative mx-auto mt-32 w-full max-w-7xl items-center px-5 sm:px-10 lg:mt-52">
          ...
          <p className="mt-4 text-2xl text-body">
            Batch is an immersive online program where Rust developers unite to
            learn, collaborate, and contribute to an exciting open-source
            project, while receiving mentorship and forming lasting connections
