    ...
    <section className="mx-auto mt-24 w-full max-w-7xl items-center px-5 sm:px-10 lg:mt-28">
      <div className="relative my-20 flex flex-col gap-5 lg:py-40 lg:pl-[278px] lg:pr-52">
        ...
        <p className="text-2xl text-head">
          “As someone who didn&apos;t have any experience in the industry and
          only a little experience in open-source, I was struggling to find a
          project I felt qualified to contribute to.
        </p>
        <p className="text-2xl text-head">
          The SB-1 batch was a great event for to get more comfortable in
          open-source, with shuttle engineers providing mentorship and guidance
          on tasks ranging from very easy to very hard.”
        </p>
      ...
      <div className="mt-72">
        <h1 className="text-center text-6xl text-head">
          Join Shuttle Batch 2023
        </h1>
