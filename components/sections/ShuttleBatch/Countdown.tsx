...
import Counter, { CountdownRenderProps, CountdownRendererFn, zeroPad } from 'react-countdown'
	...
	return (
		<>
			<section className='mx-auto mt-24 w-full max-w-7xl items-center px-5 sm:px-10 lg:mt-28'>
				<p className='mt-4 text-center text-xl text-body'>Shuttle Batch 2023 starts in</p>
