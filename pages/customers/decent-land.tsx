    ...
    <>
      ...
      <main className="flex flex-col mx-auto mt-24 gap-16 w-full max-w-[1280px] px-5 sm:px-10 lg:mt-28 items-center">
        <div className="inline-flex flex-col justify-start items-center gap-10">
          ...
          <UserQuote className="w-full max-w-[984px]">
            <div className="flex flex-col gap-10">
              <span className="text-neutral-200 text-lg md:text-2xl font-normal">
                &quot;We were spending precious dev time on infrastructure
                instead of building features that actually mattered... Then we
                found Shuttle, and it won on every single DevOps point.&quot;
              </span>
          ...
          <div className="w-full max-w-[782px] flex flex-col justify-start items-start gap-10">
            <h2 className="self-stretch justify-start text-neutral-200 text-3xl md:text-5xl font-bold font-gradual leading-tight md:leading-[57.60px]">
              The Challenge: Infrastructure Overhead Distracting from Core
              Mission
            </h2>
            <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
          ...
          <div className="w-full max-w-[782px] flex flex-col justify-start items-start gap-10">
            ...
            <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
              ...
              deployment process. The migration was remarkably quick, taking
              less than 30 minutes using Shuttle&apos;s annotation system on
              existing services.
            </p>
                ...
                {[
                  ...
                  },
                  {
                    ...
                    description: (
                      <>
                        <span className="text-text-secondary text-xl font-normal">
                          When they need support, they get it directly through
                          the team on{" "}
                        </span>
                        <Link
                        ...
                        <span className="text-text-secondary text-xl font-normal">
                          , a nice contrast to layers of impersonal support
                          bots.
                        </span>
                      </>
                    ),
          ...
          <div className="w-full max-w-[782px] flex flex-col justify-start items-start gap-10">
            ...
            <p className="self-stretch justify-start text-zinc-400 text-xl font-normal">
              ...
              for off-chain services. While WeaveVM handles the on-chain
              permanent storage and data availability, Shuttle deploys the
              supporting infrastructure such as indexers and auxiliary services
              that complement the main protocol.
              <br />
              <br />
              ...
              development more accessible to teams that want to focus on
              building robust on-chain protocols rather than managing DevOps
              complexity for their supporting services.
            </p>
          </div>
          <div className="w-full max-w-[782px] flex flex-col justify-start items-start gap-10">
            <h2 className="self-stretch justify-start text-neutral-200 text-3xl md:text-5xl font-bold font-gradual leading-tight md:leading-[57.60px]">
