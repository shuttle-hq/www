    ...
    <main className="flex flex-col mx-auto mt-24 gap-16 w-full max-w-[1280px] px-5 sm:px-10 lg:mt-28 items-center">
      <div className="inline-flex flex-col justify-start items-start gap-28">
        <div className="w-[782px] flex flex-col justify-start items-start gap-10">
          ...
          <div className="self-stretch justify-start">
            <span className="text-text-secondary text-xl font-normal">
              ...
              Built by the team behind sustainability at Palantir and backed by
              leading climate minds, their platform operates at over 1 billion
              data points, blending advanced macroeconomic modelling, financial
              engineering, and AI to project climate risk with unprecedented
              precision.
            </span>
            <span className="text-text-secondary text-xl font-normal">
              The founding team brings deep expertise in data engineering and
              software development. Their lead backend engineer joined the team
              after their move to Rust, bringing valuable backend development
        ...
        <div className="w-[782px] flex flex-col justify-start items-start gap-10">
          ...
          <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
            Companies and investors face more pronounced climate risks than ever
            before. Unwritten needed to create a single component capable of
            both performing CRUD operations on user-entered data and executing
            data processing workflows. The platform must serve enterprise
            clients who require strict security and often demand individual
            deployments.
          </p>
          <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
          ...
          <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
            &quot;Our core expertise and value lie in climate risk modelling, so
            we wanted to focus on optimising data pipelines rather than
          ...
          <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
            ...
            specific greenfield project, they decided to adopt Rust as &quot;an
            entirely new language&quot; to leverage Polars for fast data
            transformations and Axum as a type-safe server framework. The team
            chose Polars running natively in Rust, as it delivered up to 3×
            faster performance than its Python counterpart, offering superior
            parallel computing capabilities that scale efficiently with growing
            data volumes.
          </p>
          <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
        ...
        <div className="w-[782px] flex flex-col justify-start items-start gap-10">
          ...
          <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
            ...
            component, Unwritten didn&apos;t directly compare Shuttle with other
            platforms. Instead, they used their experience with Vercel for
            front-end deployments as a benchmark when assessing Shuttle&apos;s
            features. Shuttle&apos;s position as a hosting platform specifically
            designed for Rust made it the obvious choice, with its approach of
            eliminating deployment complexity crucial for adopting a new
            language.
          </p>
            ...
            <ol className="self-stretch flex flex-col justify-start items-start">
              ...
              <li className="self-stretch flex flex-col justify-start items-start">
                <div className="self-stretch py-5 border-b border-white/30 inline-flex justify-start items-baseline gap-5">
                  ...
                  <div className="flex-1 justify-start text-text-secondary text-xl font-normal">
                    Shuttle&apos;s native integration with Better Stack delivers
                    robust monitoring and observability out of the box.
                  </div>
                </div>
              </li>
            </ol>
          ...
          <p className="self-stretch justify-start text-text-secondary text-xl font-normal">
            ...
            entirely new language, offloading deployment complexity allowed them
            to focus on learning Rust and concentrate on development rather than
        ...
        <div className="w-[782px] flex flex-col justify-start items-start gap-10">
          ...
          <p className="self-stretch justify-start text-zinc-400 text-xl font-normal">
            ...
            This is particularly valuable for Unwritten&apos;s specialised team
            who excel in data engineering but were new to Rust development and
          ...
          <p className="self-stretch justify-start text-zinc-400 text-xl font-normal">
            With Shuttle, infrastructure concerns disappear—you can have a fully
            operational setup in <strong>minutes</strong> with zero specialised
            expertise. The team describes Shuttle as &quot;Vercel for
            backend.&quot;
          </p>
        </div>
        <div className="w-[782px] flex flex-col justify-start items-start gap-10">
          ...
          <p className="self-stretch justify-start text-zinc-400 text-xl font-normal">
            Unwritten&apos;s success demonstrates how Shuttle enables technology
            companies to focus on their core mission rather than infrastructure
            management. The combination of Rust&apos;s performance and
            Shuttle&apos;s deployment simplicity allowed their team to build
            production-ready data processing solutions at unprecedented speed.
          </p>
        </div>
