	...
	return (
		<main className='mx-auto mt-24 w-full max-w-7xl px-5 sm:px-10 lg:mt-28'>
			...
			<div className='mb-10 mt-10'>
				...
				<p className='mb-5 text-xl'>
					By ticking the box of our popup Cookies Policy you are agreeing to our use of cookies as
					defined herein. If you do not consent to the use of cookies, you may block or disable them
					through your browser settings as explained in this Cookies Policy. However, blocking or
				...
				<p className='mb-5 text-xl'>
					...
					website, or to store small bits of information locally with you.
				</p>
				<p className='mb-5 text-xl'>
					There are two different types of cookies: session and persistent cookies. Session cookies
					expire at the end of a browser session, so right after you exit the browser, while persistent
					cookies are stored on your computer between browsing sessions until they expire or you decide
					to delete them.
				</p>
			</div>
				...
				<table className='mb-20 table-fixed text-xs lg:text-sm'>
					<tr className='text-left children:border children:border-gray-900 children:px-1 children:py-1 lg:children:px-4 lg:children:py-3'>
						...
						<td>
							...
							including in order to log in to our services.
						</td>
					</tr>
					<tr className='text-left children:border children:border-gray-900 children:px-1 children:py-1 lg:children:px-4 lg:children:py-3'>
			...
			<div className='mb-10 mt-10 text-xl'>
				...
				<table className='mb-20 table-fixed text-xs lg:text-sm'>
					...
					<tr className='text-left children:border children:border-gray-900 children:px-1 children:py-1 lg:children:px-4 lg:children:py-3'>
						...
						<td>Auth0</td>
						<td>
							We use Okta’s Auth0 to help us authenticate users. More information on Auth0’s
							processing of personal data can be found here:
			...
			<div className='mb-10 mt-10 text-xl'>
				...
				<p className='mb-5 text-xl'>
					You may refuse to accept cookies or delete those already through the setting on your web
					browser. You may find more information here:
				</p>
				...
				<p className='mb-5 text-xl'>
					However, if you use your browser settings to block all cookies you may not be able to access
