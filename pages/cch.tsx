			...
			<section className='mx-auto mb-10 w-full max-w-5xl px-4 py-12 font-mono font-normal text-head'>
				...
				<div className='mb-8 flex flex-col text-base'>
					...
					<p>
						...
						challenges using Rust in a fun and relaxed environment. In each challenge, you&apos;ll
						implement HTTP endpoints that respond with the challenge&apos;s solution. It is a great way
					...
					<p>
						Participating gives you get the chance to improve your Rust skills, build new friendships
						with like minded Rustaceans and enjoy the run up to the holidays!
					</p>
					...
					<p>
						Completion of all 7 challenges by December 31st, 2024 at 23:59 UTC will make you eligible
						for the prize pool, so no need to rush. More details coming soon!
					</p>
