	...
	return (
		<main className='mx-auto mt-24 w-full max-w-7xl px-5 sm:px-10 lg:mt-28'>
			<div className='mb-[98px]'>
				<h1 className='mb-[19px] text-[64px] font-bold text-[#D8D8D8]'>SHUTTLE TERMS AND CONDITIONS</h1>
				...
				<p className='mb-6 text-xl'>
					By accessing and/or using our Website and/or Services or expressly accepting our Terms, you
					agree to be bound by these Terms. You may not access or use our Website or Services if you do
					not agree to or accept our Terms.
				</p>
				<p className='mb-6 text-xl'>
				...
				<p className='mb-6 text-xl'>
					...
					, which sets out the permitted uses and prohibited uses of the Website. When using the Website,
					...
					<li>
						...
						<ol className='mb-6 list-[lower-roman] space-y-6 pl-6 text-xl'>
							<li>
								...
								the Services for both yourself and that person. In such a case, you represent and
								warrant that (a) you are an authorised representative of that person, (b) you have
								authority to bind the person to these Terms, (c) you agree to these Terms on that
								person’s behalf, and (d) you will be responsible for any breach of these Terms by
								that person.
							</li>
							<li>
						...
						<ol className='mb-6 list-[lower-roman] space-y-6 pl-6 text-xl'>
							<li>
								<span className='mb-6 block'>
									...
									confidentiality of your password and other information, and for keeping your
									Account secure.
								</span>
							</li>
							...
							<li>
								<span className='mb-6 block'>
									...
									acts or omissions by you, or an unauthorised third party, if your Github
									account or Account has been compromised. Please immediately contact Github in
									the event of an issue with you Github account.
								</span>
							</li>
							...
							<li>
								...
								<ol className='mb-6 list-[lower-alpha] space-y-6 pl-6 text-xl'>
									...
									<li>
										you will provide Github with accurate, complete and current registration
										information about yourself;
									</li>
									<li>
										you are solely responsible for any and all activities in your Account,
										including any integration (and associated disclosure of data) in connection
										with the Services;
									</li>
									<li>
										you will comply with applicable laws in creating your Account and using our
										Services.
									</li>
									<li>
										you comply with our{' '}
									...
									<li>
										If you suspect that someone else accessed your Account without your
										consent, you must inform us as soon as possible by writing to
										hello@shuttle.rs, and immediately change your password.
									</li>
								</ol>
							</li>
							...
							<li>
								<span className='mb-6 block'>
									...
									any other rights or remedies available to us, we may terminate or disable an
									Account, or remove Customer Data (in whole or in part), at our absolute
									discretion, in particular if, or if we suspect that:
								</span>

								<ol className='mb-6 list-[lower-alpha] space-y-6 pl-6 text-xl'>
									<li>you are using your Account for illegal or fraudulent activities;</li>
									<li>you are providing us with false or concealed information;</li>
									<li>
										you are attempting to disrupt or overwhelm our infrastructure (e.g. by
										using bots or other forms of automation in using our Services); or
									</li>
									<li>you have breached these Terms;</li>
									<li>
										and you agree that such event will not give rise to a ground for a claim
										against us.
									</li>
								</ol>
							</li>
					...
					<li>
						...
						<ol className='mb-6 list-[lower-roman] space-y-6 pl-6 text-xl'>
							...
							<li>
								...
								overdue amount at the rate of [3]% a year above the Bank of England base rate from
								time to time. This interest accrues on a daily basis from the due date until the
								date of actual payment of the overdue amount, whether before or after judgment. You
							...
							<li>
								...
								our Services during that time. You acknowledge that in doing so, you lose on your
								right to cancel the Services. If you decide to change your mind, please reach out
								to us at hello@shuttle.rs. If you have paid us in advance, we will refund you as
								soon as possible and within 14 days of you telling us you&apos;ve changed your
								mind. We refund you by the method you used for payment. We don&apos;t charge a fee
								for the refund.
							</li>
						</ol>
					</li>
					...
					<li>
						...
						<ol className='mb-6 list-[lower-roman] space-y-6 pl-6 text-xl'>
							<li>
								...
								not endorse them or take responsibilities for them. Your relationship with the
								providers of these Third Party Services is governed by their terms and conditions;
								we are not a party to these terms with the Third Party Services providers. You
								understand that by integrating these Third Party Services with your Account, there
								will be an exchange of your Customer Data between them and us. We encourage you to
								review Github and Discords terms of service:{' '}
								<a
							...
							<li>
								...
								with the terms and conditions of these third party websites or platforms. We will
								not be responsible or liable for these websites of platforms, and do not approve or
					...
					<li>
						...
						<ol className='mb-6 list-[lower-roman] space-y-6 pl-6 text-xl'>
							...
							<li>
								...
								and feel”, logos, trade names, trade marks, designs, texts, graphics, pictures,
								information, data, software, sounds and other files, and the arrangement thereof
								(the Content) are owned by us, or our affiliates or licensors. You may not copy,
								distribute, communicate to the public, creative derivatives of or in any way use
								the Content whether in whole or in part, or use any framing techniques, without our
							...
							<li>
								...
								personal licence to access and use our Services and Website, subject to you
					...
					<li>
						...
						<ol className='mb-6 list-[lower-roman] space-y-6 pl-6 text-xl'>
							<li>
								...
								after the you sign up for our Services Confidential Information will be kept
								confidential. This obligation will apply to any employees, consultants and
								suppliers or advisors to whom the Confidential Information will need to be
								disclosed. Neither party shall use or disclose the Confidential Information of the
								other party (a) for purposes not related to the performance of these Terms, (b)
								other than as permitted by these Terms, or (c) without the prior written consent of
								the other party.
							</li>
							<li>
								<strong className='text-[#D8D8D8]'>
								...
								show (a) is in or has become part of the public domain other than as a result of a
								breach of these Terms, (b) was in its written records before receiving the
								information (other than a result of a breach), (c) was independently developed by
							...
							<li>
								...
								required by applicable law or by order of a court or governmental body or authority
								of competent jurisdiction. Where practicable and legally permitted, the party
								having to disclose the Confidential Information will consult with the other party,
								and at the other party’s request and cost, reasonably co-operate with and assist
					...
					<li>
						...
						<ol className='mb-6 list-[lower-roman] space-y-6 pl-6 text-xl'>
							<li>
								...
								by applicable law, our Services and Website are provided “as is” without warranty
								of any kind, either expressed or implied, including any implied warranty of
								merchantability, satisfactory quality, non-infringement or fitness for a particular
								purpose. If you are a Consumer, and something is wrong with the Services, please
								contact us at [EMAIL] to ask us to repeat or fix a services which is not carried
								out with reasonable care and skill, or get a refund on a pro-rata basis if we
								cannot fix it.
							</li>
							<li>
								<strong className='text-[#D8D8D8]'>
								...
								cannot guarantee it, and we cannot be liable if the Website or the Services are
								unavailable for any time or for any period. We do not guarantee that the Services
								or the Website will be uninterrupted or error-free, or comply with regulatory
								requirements, or free of viruses or other harmful components. Due to the nature of
								the Internet, this cannot be guaranteed. We may suspend or withdraw or restrict the
								availability of all or any part of the Website for business and operational
					...
					<li>
						...
						<ol className='mb-6 list-[lower-roman] space-y-6 pl-6 text-xl'>
							...
							<li>
								...
								doing something you&apos;re not allowed to, but that doesn’t mean we can&apos;t do
								it later.
							</li>
							<li>
								...
								earlier receipt, communications are deemed received: if delivered by hand, at the
								time of delivery; if sent by recorded delivery, at 9.00 am on the second business
								day after posting; or, if sent by email, at the time of transmission, and in the
								case of post or email it shall be sufficient to prove that the communication was
								properly addressed and posted or transmitted (in the case of email by way of
							...
							<li>
								...
								reasonably require for us to assess your claim. If so requested by us, the parties
								will negotiate in good faith to seek resolution of your claim. In which case, you
								agree not to bring proceedings against us for at least 60 days from the date of
								your Claim Notice.
							</li>
							<li>
