...
- **Reference images in MDX using `<CaptionedImage src="/images/blog/{slug}/{filename}" alt="..." caption="..." />`** - the `caption` prop is optional but recommended for accessibility (e.g., `<CaptionedImage src="/images/blog/build-rust-app-claude-opus-4.5/benchmarks.png" alt="Benchmark results" caption="Benchmark results comparing performance" />`)
