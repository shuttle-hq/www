...
- Learn more about how to [competently write an API with Axum](https://shuttle.dev/blog/2023/12/06/using-axum-rust)
- Secure your API with [JWT authentication](https://shuttle.dev/blog/2024/02/21/using-jwt-auth-rust)
- Learn about [getting started with logging in Rust](https://shuttle.dev/blog/2023/09/20/logging-in-rust)
