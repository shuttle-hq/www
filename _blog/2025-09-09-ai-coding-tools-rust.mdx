...
description: "We tested five AI coding tools on the same Rust project. See how each performed on speed, accuracy, and terminal vs IDE workflows."
author: shuttle 
tags: [rust, ai, coding-tools, development]
thumb: ai-coding-tools-rust/cover.png
cover: ai-coding-tools-rust/cover.png
date: '2025-09-09'
---
...
<CaptionedImage 
  src="/images/blog/ai-coding-tools-rust/kiro-ui.png" 
  alt="Kiro IDE"
  caption="Kiro IDE"
/>
...
- Steeper Learning Curve: Requires comfort with command-line workflows and provides less visual feedback compared to IDE-based tools. Popular terminal-based AI coding tools include:
  - Claude Code
  - Aider
  - Gemini CLI
  - OpenAI Codex CLI
...
<CaptionedImage 
  src="/images/blog/ai-coding-tools-rust/codex-ui.png" 
...
<CaptionedImage 
  src="/images/blog/ai-coding-tools-rust/shuttle-console.png" 
  alt="Shuttle Console"
