...
description: "Exploring how to use PostHog in a Rust application and to be able to improve product analytics."
author: josh
...
Read more:
- Get started with using Rust's most popular framework [here](https://www.shuttle.rs/blog/2023/12/06/using-axum-rust)
- Learn about logging for your Rust application [here](https://www.shuttle.rs/blog/2023/09/20/logging-in-rust)
- Check out our guide for using Stripe with Rust [here](https://www.shuttle.rs/blog/2024/03/07/stripe-payments-rust)
