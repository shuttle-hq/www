...
- Try out implementing JWT authentication [here.](https://shuttle.dev/blog/2024/02/21/using-jwt-auth-rust)
- Learn more about the Tracing ecosystem for logging [here.](https://shuttle.dev/blog/2024/01/09/getting-started-tracing-rust)
