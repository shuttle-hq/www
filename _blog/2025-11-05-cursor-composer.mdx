...
thumb: composer-hands-on/cover.png
cover: composer-hands-on/cover.png
date: "2025-11-05"
---
...
![Composer prompt for building a REST API](./images/crud-prompt.png)
...
![Composer's completion summary](./images/crud-complete.png)
...
![Composer search prompt for GitHub issue](./images/search-prompt.png)

Composer scanned the entire codebase and returned results in 15 seconds:

![Composer search results](./images/search-result.png)
...
![Composer planning prompt](./images/plan-prompt.png)

Composer generated a well-structured implementation plan:

![Composer's implementation plan](./images/plan-done.png)
...
![Implementation in args.rs](./images/review.png)
...
![shuttle run without --quiet flag](./images/shuttle-run-no-q.png)

All the build logs, runtime startup messages, and info logs appear - the default behavior. Now with `shuttle run --quiet`:

![shuttle run with --quiet flag](./images/shuttle-run-quiet.png)
