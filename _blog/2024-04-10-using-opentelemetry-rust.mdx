...
- [Get started with the tracing libraries](https://shuttle.dev/blog/2024/01/09/getting-started-tracing-rust)
- [Deploying Rust to the web](https://shuttle.dev/blog/2024/02/07/deploy-rust-web)
- [Building an uptime monitor with Rust, askama, axum and htmx](https://shuttle.dev/blog/2024/02/08/uptime-monitoring-rust)
