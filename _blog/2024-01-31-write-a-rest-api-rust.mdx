...
Installation via `cargo-binstall` is also supported, along with our other install scripts which you can find [here.](https://docs.shuttle.dev/getting-started/installation)
