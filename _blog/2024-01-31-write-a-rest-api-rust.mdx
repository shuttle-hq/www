...
In this article, we’re going to talk about writing a REST API in Rust! Following on from our first [Shuttle Bytes](https://shuttle.dev/blog/2024/01/22/introducing-shuttlebytes) stream where we live-streamed a tutorial on this, we’ve created a text write-up to allow you to follow along in text.
...
- Learn more about Axum [here.](https://shuttle.dev/blog/2023/12/06/using-axum-rust)
- Learn more about using SQL with SQLx [here.](https://shuttle.dev/blog/2023/10/04/sql-in-rust)
