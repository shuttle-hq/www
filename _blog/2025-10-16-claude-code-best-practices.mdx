...
![Claude Code interface showing the terminal with Claude Code v2.0.17](./images/claude-code.png)
...
![Clearing context with /clear](./images/claude-clear.png)
...
I use a custom command with this prompt for plan generation:
...
![Context usage showing auto-compact buffer at 45k tokens](./images/context-auto-compact.png)
...
![Config screen with auto-compact turned off](./images/config-auto-compact-off.png)

After turning off auto-compact and running `/context` again, you'll see the immediate impact:

![Clean context usage with no autocompact buffer](./images/context-clean.png)
...
![Toggle MCP servers with @ mention](./images/toggle-mcp.png)
