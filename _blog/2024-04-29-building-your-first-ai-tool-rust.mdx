...
P.S. If you'd like to learn more about Async in Rust, you can check out our [Async Rust in a Nutshell](https://shuttle.dev/blog/2024/02/29/async-rust) article!
...
Read more:
- [Creating a RAG-assisted web service with Axum](https://shuttle.dev/blog/2024/02/28/rag-llm-rust)
- [More than you've ever wanted to know about error handling](https://shuttle.dev/blog/2022/06/30/error-handling)
