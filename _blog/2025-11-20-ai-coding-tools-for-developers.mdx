  ...
  items={[
    {
      ...
      answer:
        "Cursor and Claude Code are currently the leading AI coding assistants. Cursor excels for IDE-first developers with strong autocomplete and multi-file editing. Claude Code is best for terminal-native developers who want natural language control. Many developers use both together for maximum productivity.",
    },
    {
      question: "Are AI coding assistants free to use?",
      answer:
        "Most AI coding tools offer free tiers. GitHub Copilot has a generous free tier, Gemini CLI is free with a Google account, and browser-based tools like Bolt and Lovable offer limited free usage. Cursor and Claude Code require paid subscriptions for full access.",
    },
    {
      question: "Can AI coding assistants replace developers?",
      answer:
        "No. AI coding assistants are productivity tools, not replacements. They excel at boilerplate, autocomplete, and routine tasks, but still require human oversight for architecture decisions, code review, security considerations, and understanding business requirements.",
    },
    {
      question: "Which AI model is best for coding tasks?",
      answer:
        "Claude Opus 4.5 is currently the best coding model, available in Claude Code and Cursor. GPT-5.1 excels at reasoning tasks, while Gemini 3 Pro offers the largest context window for analyzing big codebases. Different models have different strengths.",
    },
    {
      question: "Should I use multiple AI coding tools together?",
      answer:
        "Yes. Many developers combine tools based on their strengths: Cursor for fast autocomplete and quick edits, Claude Code for complex multi-file refactoring, and GitHub Copilot for understanding unfamiliar codebases. Using the right tool for each task improves productivity.",
    },
    {
      question:
        "What's the difference between IDE-based and CLI AI coding tools?",
      answer:
        "IDE-based tools like Cursor and Windsurf provide visual interfaces with inline suggestions, multi-file editing, and agent modes built into the editor. CLI tools like Claude Code and Gemini CLI run in your terminal, offering natural language control and better integration with shell workflows.",
    },
  ]}
/>
