...
- Want to use raw SQL instead? Check out our article about SQLx [here.](https://shuttle.dev/blog/2023/10/04/sql-in-rust)
- Interested in finding the best web framework for you? Check out our comparison article [here.](https://shuttle.dev/blog/2023/08/23/rust-web-framework-comparison)
