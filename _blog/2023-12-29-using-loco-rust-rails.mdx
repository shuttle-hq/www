...
Once the scaffold is done, you may notice that your controller and other relevant parts have been added in `app.rs`, so there is no need to add it manually.
