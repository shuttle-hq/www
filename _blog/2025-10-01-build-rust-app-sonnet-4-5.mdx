---
title: "Building a Rust App with Claude Sonnet 4.5: Testing the 'Best Coding Model'"
...
thumb: build-rust-app-with-sonnet-4-5/cover.png
cover: build-rust-app-with-sonnet-4-5/cover.png
date: "2025-10-01"
---
...
<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/vscode-extension.png"
...
<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/claude-interface.png"
...
<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/initial-implementation.png"
...
<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/testing-rss-curl.png"
  alt="Testing RSS feed with curl"
  caption="Testing RSS feed with curl"
/>

<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/feed-normalization.png"
...
<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/rss-output.png"
  alt="RSS feed output"
...
<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/fetching-docs.png"
  alt="Fetching documentation"
  caption="Fetching documentation"
/>

<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/outdated-crates.png"
...
<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/dependencies-updated.png"
  alt="Updated dependencies"
  caption="Updated dependencies"
/>

<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/axum-route-update.png"
...
With a working application in hand, there was one more test: deployment. Claude Code has MCP (Model Context Protocol) integration with Shuttle, so I wanted to see if Sonnet could handle the entire deployment workflow.
...
With just one prompt `Deploy to Shuttle` my app was up and running in a few minutes.

<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/shuttle-deploy.png"
  alt="Deploying to Shuttle"
  caption="Deploying to Shuttle"
/>

<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/deployment-success.png"
  alt="Deployment success"
  caption="Deployment success"
/>

<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/deployment-logs.png"
...
<CaptionedImage
  src="/images/blog/build-rust-app-with-sonnet-4-5/live-application.png"
  alt="Live application URL"
  caption="Live application URL"
/>
