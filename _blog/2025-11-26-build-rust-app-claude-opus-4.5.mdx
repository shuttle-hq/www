---
title: "Building a Full-Stack Rust Web App with Claude Opus 4.5 in One Prompt"
...
thumb: rust-app-opus-4.5/cover.png
cover: rust-app-opus-4.5/cover.png
date: "2025-11-26"
---
...
![Opus 4.5 benchmark results](images/benchmarks.png)
...
![Empty Shuttle Axum project](images/empty-project.png)
...
![Cursor Agent view with the prompt](images/cursor-agent-view-prompt.png)
...
![Opus searching Shuttle documentation](images/search-docs.png)
...
![Opus writing 2.5k lines of code](images/2.5k-lines-written.png)
...
![Up-to-date crate versions](images/versions.png)

## The Build Process

Claude Opus 4.5 organized its work into a clear todo list, systematically checking off each step:

![Opus working through the todo list](images/opus-cooking.png)
...
![Opus debugging the build process](images/sqlx-prepare-error.png)

Once it worked through those issues, it compiled successfully. No missing dependencies, no type errors, no syntax issues. 18 seconds to build the entire project.
...
![Running database migrations locally](images/pg-command.png)

That's it. One prompt, one password fix (which was entirely my fault for not providing it), and everything else worked perfectly.
...
![Successful compilation](images/deploy.png)

## The Result

A few minutes later, the deployment completed successfully:

![Deployment summary](images/summary.png)
...
![Features implemented](images/features-summary.png)
...
![The finished finance tracker application](images/finance-dashboard.png)
...
![Finance tracker dashboard](images/finance-dashboard.png)
...
![Transactions page with filtering](images/transactions.png)
...
![Budget tracking with progress bars](images/budgets.png)
...
![Analytics view with income vs expenses](images/analytics.png)

![Analytics showing expense breakdown](images/analytics-2.png)
...
![Add transaction modal](images/dialog.png)
