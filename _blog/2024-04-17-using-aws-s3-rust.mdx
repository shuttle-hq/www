...
- [Building a notification service with Rust & AWS SNS](https://shuttle.dev/blog/2024/03/20/notification-service-rust)
- [Learn more about Axum](https://shuttle.dev/blog/2023/12/06/using-axum-rust)
- [Using OpenTelemetry with Rust](https://shuttle.dev/blog/2024/04/10/using-opentelemetry-rust)
