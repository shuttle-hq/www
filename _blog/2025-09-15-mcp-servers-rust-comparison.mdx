...
description: "Compare the best MCP servers for Rust development. Learn how to deploy Rust applications directly from your IDE."
author: adetokunbo
...
> The URLs used in the following steps are examples. When you deploy your own application, Shuttle will provide you with a unique URL._
...
<CaptionedImage
  src="/images/blog/mcp-servers-rust-comparison/shuttle-deploy-using-ai-assistant.png"
  alt="How to deploy Rust application using Shuttle MCP Server"
  caption="Deploying Rust application using Shuttle MCP Server through AI assistant"
/>

<CaptionedImage
  src="/images/blog/mcp-servers-rust-comparison/shuttle-console.png"
...
<CaptionedImage
  src="/images/blog/mcp-servers-rust-comparison/postman-shuttle-health-endpoint.png"
...
<CaptionedImage
  src="/images/blog/mcp-servers-rust-comparison/postman-shuttle-post-endpoint.png"
...
<CaptionedImage
  src="/images/blog/mcp-servers-rust-comparison/postman-shuttle-single-all-endpoint.png"
  alt="Postman request to retrieve all snippets"
  caption="Retrieving all snippets via GET request - Postman showing successful response"
/>
...
<CaptionedImage
  src="/images/blog/mcp-servers-rust-comparison/postman-request-single-snippet-endpoint.png"
  alt="Postman request to retrieve a single snippet"
  caption="Retrieving a specific snippet by ID - Postman showing successful response"
/>
...
<CaptionedImage
  src="/images/blog/mcp-servers-rust-comparison/github-mcpserver.png"
  alt="Using GitHub MCP Server to raise PR"
  caption="Using GitHub MCP Server to create a pull request with AI assistant"
/>
...
<CaptionedImage
  src="/images/blog/mcp-servers-rust-comparison/context7-mcp-server-1.png"
  alt="How to use context7 MCP Server"
  caption="Using Context7 MCP Server to access Rust documentation and code examples"
/>
