...
Additionally, we also have an article about what framework you should use [here.](https://shuttle.dev/blog/2023/08/23/rust-web-framework-comparison)
...
- Get more in-depth with Axum [here.](https://shuttle.dev/blog/2023/12/06/using-axum-rust)
- Learn more about tracing libraries and improve application logging [here.](https://shuttle.dev/blog/2024/01/09/getting-started-tracing-rust)
