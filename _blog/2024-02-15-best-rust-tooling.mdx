...
- Learn how to deploy a Rust API with Axum, Postgres and Shuttle [here](https://shuttle.dev/blog/2024/01/31/write-a-rest-api-rust)
- Get started with logging in Rust [here](https://shuttle.dev/blog/2023/09/20/logging-in-rust)
