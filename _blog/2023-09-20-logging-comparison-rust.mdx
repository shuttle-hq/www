---
title: What Rust Logger Crate Should You Use in 2023?
...
author: josh
tags: [rust, logging, comparison]
thumb: 
cover: 
date: '2023-09-20T14:00:00'
---
# A Rust Logging Crate Comparison in 2023
...
As you can see, `log4rs` is an extremely versatile crate that works with the previously mentioned `log` crate to provide powerful functionality with regards to logging in Rust. However, in exchange for this you have to learn how to set the logger up and the setup itself is quite complicated compared to other logging crates, so bear that in mind.
