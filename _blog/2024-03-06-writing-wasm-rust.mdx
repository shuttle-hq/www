...
To get started, you’ll need Rust installed. If you don’t, you can install it [here](https://www.rust-lang.org/install).
...
With our current example, you would want to do something like this:
...
- We wrote a list of [our top 8 Rust tools to speed up your productivity](https://www.shuttle.rs/blog/2024/02/15/best-rust-tooling)
- Here’s our guide to [getting started with Axum, Rust's most popular framework](https://www.shuttle.rs/blog/2023/12/06/using-axum-rust)
- We wrote about our [top 8 tools to help you be more productive in Rust](https://www.shuttle.rs/blog/2024/02/15/best-rust-tooling)
