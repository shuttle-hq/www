...
- Read more about using SQL with SQLx [here](https://shuttle.dev/blog/2023/10/04/sql-in-rust).
- Read more about session token based authentication [here](https://shuttle.dev/blog/2022/08/11/authentication-tutorial).
