...
## Finishing Up
Thanks for reading! `actix-web` is a strong framework that you can use to boost your Rust portfolio and is a great framework to do a deep dive into Rust on as it requires you to deal specifically with futures and async to utilise fully.
