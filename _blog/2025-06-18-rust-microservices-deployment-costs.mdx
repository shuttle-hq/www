...
<QA
  ...
  answer="Try the ShellCon Challenge (https://github.com/shuttle-hq/shuttle-shellcon). It's a hands-on Rust app with multiple services (Axum, SQLx, async) that you fix and deploy using Shuttle."
/>
