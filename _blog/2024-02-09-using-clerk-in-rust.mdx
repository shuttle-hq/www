...
description: This article covers how to use Clerk authentication in Rust backends along with integrating a shared database using Shuttle. To demonstrate the extensive usage we will be building REST APIs that can be used in React frontend protected by Clerk. 
