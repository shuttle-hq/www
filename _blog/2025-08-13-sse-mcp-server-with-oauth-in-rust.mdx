...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector.png" 
  alt="MCP inspector"
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-auth-settings.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-auth-settings-open.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-auth-settings-open-auth-settings.png" 
  alt="MCP inspector auth settings"
  caption="MCP inspector auth settings"
/>
...
The `init()` function contains all the `rmcp` boilerplate required to spin up the SSE transport MCP server. You can view the [complete implementation here](https://github.com/shuttle-hq/shuttle-examples/tree/main/mcp/mcp-sse-oauth/blob/main/src/init.rs).
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/development-server-running.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-metadata-endpoint.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-client-registration-endpoint.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-authorization-endpoint.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-authorization-endpoint-consent-screen.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-authorization-endpoint-display-authorization-code.png" 
...
See the [full implementation here](https://github.com/shuttle-hq/shuttle-examples/tree/main/mcp/mcp-sse-oauth/blob/main/src/auth/token.rs).
