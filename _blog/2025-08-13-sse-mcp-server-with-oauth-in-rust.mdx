...
thumb: sse-mcp-server-with-oauth-in-rust/cover.png
cover: sse-mcp-server-with-oauth-in-rust/cover.png
date: '2025-08-13'
takeaways:
    - SSE MCP servers enable AI agents to connect to cloud-hosted MCP servers with OAuth 2 authentication for secure user access control
    - The rmcp crate with Axum provides seamless MCP protocol compliance and automatic JSON-RPC schema generation
    - "OAuth 2 flow requires multiple endpoints to be implemented to be compliant with the OAuth 2 specification"
    - Shuttle simplifies deployment with PostgreSQL provisioning and one-command deployments for production-ready MCP servers
---
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/notion-mcp-server-in-cursor.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/notion-authorize-page.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-run.png" 
  alt="Running the MCP inspector"
  caption="Running the MCP inspector"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-dashboard.png" 
  alt="MCP inspector dashboard"
  caption="MCP inspector dashboard"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-open-auth-settings.png" 
  alt="MCP inspector open Auth settings"
  caption="MCP inspector open Auth settings"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-auth-flow.png" 
  alt="MCP inspector auth flow"
  caption="MCP inspector auth flow"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/shuttle-console-url.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/shuttle-development-server-running.png" 
  alt="Shuttle Development server running"
  caption="Shuttle Development server running"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-server-url.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-metadata-endpoint-success.png" 
  alt="MCP inspector metadata endpoint success"
  caption="MCP inspector metadata endpoint success"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-client-registration-endpoint-success.png" 
  alt="MCP inspector client registration endpoint success"
  caption="MCP inspector client registration endpoint success"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-authorization-endpoint-success.png" 
  alt="MCP inspector authorization endpoint success"
  caption="MCP inspector authorization endpoint success"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/authorization-endpoint-consent-screen.png" 
  alt="Authorization endpoint consent screen"
  caption="Authorization endpoint consent screen"
/>

Click "Authorize"

<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-displaying-authorization-code.png" 
  alt="MCP inspector displaying authorization code"
  caption="MCP inspector displaying authorization code"
/>

The inspector now **displays** the **authorization code** from the backend, which we'll use in the next step.

<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-authorization-success.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-inspector-token-endpoint-success.png" 
  alt="MCP inspector token endpoint success"
  caption="MCP inspector token endpoint success"
/>
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-server-requires-login.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-server-authorization-page.png" 
...
<CaptionedImage 
  src="/images/blog/sse-mcp-server-with-oauth-in-rust/mcp-server-connected.png" 
