...
- Learn about implementing authentication for your application [here.](https://shuttle.dev/blog/2024/02/21/using-jwt-auth-rust)
- Learn about rate limiting your API [here.](https://shuttle.dev/blog/2024/02/22/api-rate-limiting-rust)
- Learn more about writing Axum [here.](https://shuttle.dev/blog/2023/12/06/using-axum-rust)
