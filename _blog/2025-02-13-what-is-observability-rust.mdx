...
We're excited to announce that **starting** **next** **week**, **Pro** **Tier** users will have access to our new observability features, allowing you to send logs and traces to your preferred provider (that supports OTel)! Our Shuttle runtime takes care of the whole process for you end-to-end, allowing you to simply use your API key with a relevant supported provider and it’ll **just** work. Our initial launch will support BetterStack integration, with plans to expand to other providers like Datadog in the coming months.
