...
If you made it to this part, you probably are really interested in kube-rs, while the library is pretty neat, kubernetes has a LOT of API’s and a can quickly get confusing. When working with kube-rs or kubernetes in general here are some things to keep in mind.
