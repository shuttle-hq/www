...
At Shuttle, we believe deploying your Rust application should feel as natural as writing it. That's why we've built a new **GitHub integration** that takes you from _push_ to _production_ automatically.
...
1. Head to your [**Integrations**](https://www.notion.so/240fb1d34dbf8099b395ff1f792ff839?pvs=21) page at
...
Don't have a repository yet? Shuttle's **GitHub templates** make it easy to start.

Pick a template from our [Templates page](https://console.shuttle.dev/new-project), connect your GitHub account, and Shuttle automatically:
