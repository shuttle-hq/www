...
I'm using [shuttle](https://shuttle.dev) for this project. It's a serverless platform built for Rust and I don't have to deal with provisioning databases, or subdomains or any of that gunk. I already have the CLI [installed](https://docs.rs/shuttle-service/0.2.5/shuttle_service/#deploying) and an [account](https://shuttle.dev/) so I simply:
