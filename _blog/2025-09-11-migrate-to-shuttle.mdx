...
![Shuttle Authorize Page](/images/blog/migrate-to-shuttle/authorize.png)
...
![Add to Cursor](/images/blog/migrate-to-shuttle/add-to-cursor.png)
...
![Verify Installation](/images/blog/migrate-to-shuttle/verify-shuttle-mcp-working.png)
...
![Shuttle search tool call](/images/blog/migrate-to-shuttle/shuttle-search-tool-call.png)
...
![Shuttle deploy](/images/blog/migrate-to-shuttle/deploy-shuttle.png)

Cursor will call the `deploy` tool to deploy the project to Shuttle and Shuttle will start building your project.

![Shuttle building](/images/blog/migrate-to-shuttle/deployments.png)

After building is done, you can see the project URL in your Shuttle console and visit the website.

![Shuttle console](/images/blog/migrate-to-shuttle/shuttle-console-url.png)

Opening the project URL in the browser, you can see the website is working.

![Todo app hosted working](/images/blog/migrate-to-shuttle/todo-app-hosted-working.png)
