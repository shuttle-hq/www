...
![Shuttle Authorize Page](/videos/how-to-use-cursor-shuttle/authorize.png)
...
![Add to Cursor](/videos/how-to-use-cursor-shuttle/add-to-cursor.png)
...
![Verify Installation](/videos/how-to-use-cursor-shuttle/verify-shuttle-mcp-working.png)
...
![Shuttle search tool call](/videos/how-to-use-cursor-shuttle/shuttle-search-tool-call.png)
...
![Shuttle deploy](/videos/how-to-use-cursor-shuttle/deploy-shuttle.png)

Cursor will call the `deploy` tool to deploy the project to Shuttle and Shuttle will start building your project.

![Shuttle building](/videos/how-to-use-cursor-shuttle/deployments.png)

After building is done, you can see the project URL in your Shuttle console and visit the website.

![Shuttle console](/videos/how-to-use-cursor-shuttle/shuttle-console-url.png)

Opening the project URL in the browser, you can see the website is working.

![Todo app hosted working](/videos/how-to-use-cursor-shuttle/todo-app-hosted-working.png)
