...
- [Why Enums in Rust feel so much better](https://shuttle.dev/blog/2023/11/23/enums-in-rust)
- [Async Rust in a nutshell](https://shuttle.dev/blog/2024/02/29/async-rust)
