...
<CaptionedImage
  src="/images/blog/build-rust-api-with-sonnet-4-5/shuttle-dependencies.png"
  alt="Adding Shuttle dependencies"
  caption="Adding Shuttle dependencies"
/>

Then converted the app to a Shuttle app.

<CaptionedImage
  src="/images/blog/build-rust-api-with-sonnet-4-5/shuttle-conversion.png"
  alt="Converting to Shuttle app"
  caption="Converting to Shuttle app"
/>
