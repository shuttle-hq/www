...
their strengths and weaknesses, we recently did a [Rust web framework deep-dive](https://shuttle.dev/blog/2023/08/23/rust-web-framework-comparison).
...
too. One of them is [Shuttle](https://shuttle.dev/), of course, and the way
