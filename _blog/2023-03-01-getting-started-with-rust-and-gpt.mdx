...
You will need to set up your login for `cargo-shuttle` by simply going to our [login](https://shuttle.dev), logging in via GitHub and then using the login command with the API key flag, as without this you can't deploy anything.
