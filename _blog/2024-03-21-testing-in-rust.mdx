...
- Check out our guide for [getting started with Tracing](https://www.shuttle.dev/blog/2024/01/09/getting-started-tracing-rust)
- Learn more about [writing a REST API with Rust](https://www.shuttle.dev/blog/2024/01/31/write-a-rest-api-rust)
- Check out our [recently updated article about using OAuth2 with Rust](https://www.shuttle.dev/blog/2023/08/30/using-oauth-with-axum)
