...
![Cursor's first coding model](./images/first-coding-model.png)
...
![Composer benchmark results](./images/composer-benchmark.png)
...
![New agents mode](./images/new-agents-mode.png)
...
![Built-in browser](./images/build-in-browser.png)
...
![Review changes view](./images/review-changes-view.png)
