...
![Enabling the skill-creator in Claude settings](./images/skill-creator-on.png)
...
![Prompting Claude to create a Shuttle skill](./images/skill-creator-prompt.png)

Claude loads the `skill-creator` skill and starts reading its content to understand how to build a proper skill:

![Claude reading the skill-creator guide](./images/read-skill-creator.png)

Then it gets to work, creating the skill structure and gathering context about Shuttle's patterns:

![Claude collecting context for the skill](./images/claude-collect-context.png)
...
![Changes made to improve the skill](./images/next-iteration.png)
...
![The completed Shuttle skill](./images/skill-created.png)
...
![Unzipping the Shuttle skill](./images/unzip-shuttle-skill.png)
...
![Skill installed in the .claude/skills directory](./images/skill-structure.png)
...
![Prompting Claude to build and deploy a Shuttle app](./images/shuttle-app-prompt.png)
...
![Claude Code requesting permission to use the Shuttle skill](./images/use-skill.png)
...
![Claude Code building the todo application](./images/claude-coding.png)
...
![Deploying the todo application to Shuttle](./images/deploy.png)
