...
If you’re interested in using `serde-json` for your Rust application, we have an article talking about JSON parsing libraries which you can check out [here.](https://shuttle.dev/blog/2024/01/18/parsing-json-rust)  
...
Read more:
- Read more about how you can get started with the Rocket web framework [here.](https://shuttle.dev/blog/2023/12/13/using-rocket-rust)
- Read more about using JSON parsers [here.](https://shuttle.dev/blog/2024/01/18/parsing-json-rust)
