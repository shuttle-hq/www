...
- Find out more about the Axum framework [here.](https://shuttle.dev/blog/2023/12/06/using-axum-rust)
- Find out more about using a database with SQLx [here.](https://shuttle.dev/blog/2023/10/04/sql-in-rust)
