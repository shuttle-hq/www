...
- [Building Your First AI Tool in Rust - shuttle.dev](https://shuttle.dev/blog/2024/04/29/building-your-first-ai-tool-rust)
- [Using Huggingface with Rust - shuttle.dev](https://shuttle.dev/blog/2023/03/01/getting-started-with-rust-and-gpt)
