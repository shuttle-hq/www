...
thumb: oauth-with-axum-thumbnail.png
cover: oauth-with-axum-thumbnail.png
...
We'll first learn to use the [oauth2](https://crates.io/crates/oauth2) library to authorise our users using database-backed sessions to 
...
# Finishing Up
Thanks for reading! I hope you enjoyed this guide to implementing OAuth in Rust and leveraging the [oauth2](https://crates.io/crates/oauth2) library for Rust auth.
