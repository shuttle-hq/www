...
Nonetheless, Axum is my personal favourite, and also the framework I use for [Shuttle Launchpad](https://shuttle.dev/launchpad). I love the expressiveness and the concepts underneath, and there hasn't been a thing that I wanted to solve that I couldn't do inutitively by understanding the right concepts. If you want to get to know the Axum concepts, check out my [slides from my Tokio + Microservices workshop](https://fettblog.eu/slides/microservices-with-rust-and-tokio/).
