...
**Ready to build observable data pipelines? Try the complete example on Shuttle with one-click deployment:** [**Deploy Observable Pipeline**](https://github.com/shuttle-hq/shuttle-examples/tree/main/axum/polars-otel-shuttle)
