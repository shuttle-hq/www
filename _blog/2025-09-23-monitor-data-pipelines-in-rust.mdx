...
![Screenshot of dataset sample showing column structure and data types of NYC Taxi csv files.](/images/blog/monitor-data-pipelines/screenshot-of-dataset-sample-showing-column-structure-and-data-types-of-nyc-taxi-csv-files.png)
...
![Memory usage monitoring for Polars ETL execution.](/images/blog/monitor-data-pipelines/memory-usage-monitoring-for-polars-etl-execution.png)
...
![Open Telemetry Better Stack Portal](/images/blog/monitor-data-pipelines/screenshot-showing-open-telemetry-betterstack-portal.png)

![OpenTelemetry BetterStack Portal with Logs and Traces](/images/blog/monitor-data-pipelines/screenshot-showing-opentelemetry-betterstack-portal-with-logs-and-traces.png)
...
![Observable Pipeline Deployed on Shuttle](/images/blog/monitor-data-pipelines/screenshot-of-observable-pipeline-deployed-on-shuttle.png)![Observable Pipeline CLI Benchmarks](/images/blog/monitor-data-pipelines/screenshot-of-pbservable-pipeline-cli-benchmarks.png)![Observable Pipeline Showing CLI Telemetry information](/images/blog/monitor-data-pipelines/screenshot-of-pbservable-pipeline-showing-cli-telemetry-information.png)![Observable Pipeline Showing CLI Telemetry information](/images/blog/monitor-data-pipelines/screenshot-of-pbservable-pipeline-showing-cli-telemetry-information.png)![Observable Pipeline Showing CLI Telemetry information](/images/blog/monitor-data-pipelines/screenshot-of-pbservable-pipeline-showing-cli-telemetry-information.png)![Observable Pipeline Showing CLI Telemetry Information](/images/blog/monitor-data-pipelines/screenshot-of-pbservable-pipeline-showing-cli-telemetry-information.png)![Shuttle Showing the Deployed Application Running](/images/blog/monitor-data-pipelines/screenshot-of-shuttle-showing-the-deployed-application-running.png)
...
![Betterstack Dashboard showing the average cpu usage time in the data pipeline.](/images/blog/monitor-data-pipelines/betterstack-dashboard-showing-the-average-cpu-usage-time-in-the-data-pipeline.png)![Betterstack Dashboard showing the clean stage etl performance in the data pipeline.](/images/blog/monitor-data-pipelines/betterstack-dashboard-showing-the-clean-stage-etl-performance-in-the-data-pipeline.png)
