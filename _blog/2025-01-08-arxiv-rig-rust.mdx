...
## Why Rig?
Rig (by [Playgrounds](https://playgrounds.network/), who also additionally maintains [arc.fun](https://arc.fun)) is a new up-and-coming Rust framework designed to make AI agent creation as easy as possible. It can currently create agentic pipelines with conversation capability, integrate RAG with AI agents as well as exposing an API that you can use to create your own tools.
...
## Deploying
If you've added any frontend assets, make sure you add them to a `Shuttle.toml` file in your root folder:
