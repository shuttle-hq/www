...
description: This article shows how to build a React frontend with Clerk authentication.
...
This article covers the React frontend, and the [first part](https://www.shuttle.rs/blog/2024/02/13/clerk-in-rust) covers the Rust backend.
...
In the `frontend` directory of the template we've been building from in [Part 1](https://www.shuttle.rs/blog/2024/02/13/clerk-in-rust), let’s explore some of the React libraries that the template has provided us.
