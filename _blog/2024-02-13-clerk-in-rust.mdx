...
This article covers the Rust backend, and the [second part](https://shuttle.dev/blog/2024/02/13/clerk-in-react) covers the React frontend.
...
Follow along to [part 2](https://shuttle.dev/blog/2024/02/13/clerk-in-react) where we build the frontend and deploy.
