...
- [Building a RAG web service with Qdrant & Rust](https://shuttle.dev/blog/2024/02/28/rag-llm-rust)
- [Prompting AWS Bedrock with the AWS Rust SDK](https://shuttle.dev/blog/2024/05/10/prompting-aws-bedrock-rust)
