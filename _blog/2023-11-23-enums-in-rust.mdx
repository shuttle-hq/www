...
- Find out more about macros [here.](https://shuttle.dev/blog/2022/12/23/procedural-macros)
- Find out more about [using design patterns in Rust.](https://shuttle.dev/blog/2022/07/28/patterns-with-rust-types)
