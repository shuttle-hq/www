...
Read more:
- [Getting started with Actix Web](https://shuttle.dev/blog/2023/12/15/using-actix-rust)
- [An intro to advanced Rust traits and generics](https://shuttle.dev/blog/2024/04/18/using-traits-generics-rust)
- [Why type safety is important](https://shuttle.dev/blog/2023/11/29/type-safety)
