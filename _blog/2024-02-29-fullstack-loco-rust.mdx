...
- Try using Qdrant and OpenAI to add a RAG-based LLM to your SaaS [here.](https://www.shuttle.rs/blog/2024/02/28/rag-llm-rust)
- Add tracing to your project for better logging [here.](https://www.shuttle.rs/blog/2024/01/09/getting-started-tracing-rust)
- Try implementing Oauth2-based authentication [here.](https://www.shuttle.rs/blog/2023/08/30/using-oauth-with-axum)
