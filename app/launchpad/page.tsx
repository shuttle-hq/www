  ...
  return (
    <>
      ...
      <section className="relative mx-auto max-w-[600px] px-5 pb-28 pt-28 sm:px-10">
        ...
        <p className="mb-[40px]">
          For our upcoming issues, we have some exciting project ideas lined up
          for you, such as an e-commerce application that performs safe
          transactions with a payment provider and an Activity Pub Client. Each
          project takes you from basics to advanced concepts.
        </p>
